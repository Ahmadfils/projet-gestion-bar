L'application qui va vous aider a faire la gestion d'un restaurant, ou d'un bar, peut etre utilisé dans une alimentation.
Elle nous facilite a faire la gestion de personnel, de commandes, des produits, des stocks, ainsi les statistiques et les calculs 
de vente. Je l'ai réalisé ce projet lors d'une formation en langage de programmation JAVA.
